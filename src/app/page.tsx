...
export default () => {
        return (
                <section className='bg-[url(/bg.png)] bg-no-repeat bg-cover pt-30 h-180 max-sm:bg-right max-sm:before:absolute before:w-full before:h-full before:bg-white before:top-26 before:opacity-70 before:z-0 max-xs:before:top-21 relative'>
                        <div className='wrapper relative z-10'>
                                ...
                                <p className='text-lg opacity-50 leading-11 w-[45%] mt-5 mb-7.5 max-md:w-full'>
